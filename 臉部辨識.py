  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/JavaOliverLu/python/blob/master/%E8%87%89%E9%83%A8%E8%BE%A8%E8%AD%98.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "source": [
        ...
        "filname=input(\"請輸入檔名\")\n",
        "img = face_recognition.load_image_file(filname)\n",
        "# face_encodings(img)\n",
